        ...
        <>
            ...
            <div className="flex p-40">
                <div className="">
                    ...
                    <div className="mt-10">
                        <button type="button" class="text-white bg-purple-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-semibold rounded-full text-base px-8 py-7 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            EXPLORE WORKS
